...
{
    /// <summary>
    /// Editor for the <see cref="HandPinchReferenceSystemCalculator"/> class
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public class HandPinchReferenceSystemCalculatorEditor : MonoBehaviour
    {
        /// <summary>
        /// Custom editor for an <see cref="XRHandTrackingEvents"/>.
        /// </summary>
        [CustomEditor(typeof(SingleJointReferenceSystemCalculator), true), CanEditMultipleObjects]
        public class XRHandTrackingEventsEditor : BaseXRHandsEditor
        {
            ...
            SerializedProperty m_handJoint;
            ...
            void OnEnable()
            {
                ...
                m_handJoint = serializedObject.FindProperty("m_jointId");
            ...
            void DrawInspector()
            {
                ...
                EditorGUILayout.PropertyField(m_handJoint);
